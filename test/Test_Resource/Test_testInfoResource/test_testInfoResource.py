...
@pytest.mark.resource
def test_delete_testInfoResource():
...
@pytest.mark.resource
def test_post_testInfoResource():
...
@pytest.mark.resource
def test_get_query_testInfoResource():
...
@pytest.mark.resource
def test_joint_query_testInfoResource():
